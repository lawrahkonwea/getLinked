    ...
    <div className="section border-bt">
      <div className="flex w-full pl-[4.2%] lg:pr-[7.7%] pr-[4.2%] lg:pb-[120px] pb-[58.65px] lg:pt-[75px] pt-[15px] flex-col lg:flex-row">
        ...
        <div ref={ref} className={`${scrollY ? 'animate__slideInUp' : ''} animate__animated flex-1 lg:ml-[53px]`}>
          <h1 className="lg:text-[32px] text-[20px] text-center lg:text-start font-bold font-clash-display w-full lg:w-[267px]">
            Judging Criteria
            <br />
          ...
          <div className="lg:mt-[21px] mt-4 lg:mb-[55px] mb-10 flex flex-col lg:gap-[22px] gap-5">
            <p className="lg:text-[14px] text-center lg:text-start text-[12px]">
              <span className="font-bold lg:text-[16px] text-[13px] text-tertiary">Innovation and Creativity:</span>
              {' '}
            ...
            <p className="lg:text-[14px] text-center lg:text-start text-[12px]">
              <span className="font-bold lg:text-[16px] text-[13px] text-tertiary">Functionality:</span>
              {' '}
              Assess how well the solution works. Does it perform its
              intended functions effectively and without major issues? Judges would
              consider the completeness and robustness of the solution.
            </p>
            <p className="lg:text-[14px] text-center lg:text-start text-[12px] mt-[5px]">
              <span className="font-bold lg:text-[16px] text-[13px] text-tertiary">Impact and Relevance:</span>
              {' '}
            ...
            <p className="lg:text-[14px] text-center lg:text-start text-[12px] mt-[1px]">
              <span className="font-bold lg:text-[16px] text-[13px] text-tertiary">Technical Complexity:</span>
              {' '}
              Evaluate the technical sophistication of the solution.
              Judges would consider the complexity of the code, the use of advanced
              technologies or algorithms, and the scalability of the solution.
            </p>
            <p className="lg:text-[14px] text-center lg:text-start text-[12px] mt-[6px]">
              <span className="font-bold lg:text-[16px] text-[13px] text-tertiary">Adherence to Hackathon Rules:</span>
              {' '}
