...
export default function ContactForm() {
  ...
  const initialValues = {
    first_name: '', email: '', phone_number: '', message: '',
  };
  ...
  return (
    <form className="lg:mt-[34px] mt-[30px]">
      <div className="lg:mb-[42px] mb-[25px]">
        <input
          ...
          onChange={(e) => {
            setContactData((val) => ({ ...val, [e.target.name]: e.target.value }));
          }}
        />
      ...
      <div className="mb-[31px]">
        <textarea
          className="w-full text-[16px] lg:py-[6px] py-[27px] px-6 lg:px-[15px]"
          placeholder="Message"
          name="message"
