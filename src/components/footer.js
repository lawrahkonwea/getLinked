    ...
    return (
        <div className='section-plain desktop:pt-[70px] desktop:pb-[54px] pb-5 px-[15%]'>
            <div ref={ref} className={`${scrollY ? 'animate__slideInUp' : ''} animate__animated w-full flex flex-col desktop:flex-row`}>
                <img src={Star2} alt='star' className='animate__animated animate__flash animate__infinite animate__slower desktop:w-[15px] w-[9px] desktop:h-[18px] h-[10px] desktop:mt-[3%] mt-[10%] -ml-[5%] absolute'/>
                ...
                <div className='flex-1 flex flex-col desktop:flex-row justify-between'>
                    ...
                    <div className='mt-16 desktop:mt-0'>
                        ...
                        <img src={Star3} alt='star' className='animate__animated animate__flash animate__infinite animate__slower desktop:w-[15px] w-[7px] desktop:h-[18px] h-2 absolute desktop:-ml-[5%] ml-[30%]' />
