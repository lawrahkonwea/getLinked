...
import Star3 from '../assets/star-opaque.png';
...
export default function Footer() {
  ...
  return (
    <div className="section-plain lg:pt-[70px] lg:pb-[54px] pb-5 px-[15%]">
      <div ref={ref} className={`${scrollY ? 'animate__slideInUp' : ''} animate__animated w-full flex flex-col lg:flex-row`}>
        <img src={Star2} alt="star" className="animate__animated animate__flash animate__infinite animate__slower lg:w-[15px] w-[9px] lg:h-[18px] h-[10px] lg:mt-[3%] mt-[10%] -ml-[5%] absolute" />
        <div className="lg:w-[60%] w-full">
          <div className="lg:w-[80%] w-full">
            <h1 onClick={() => navigate('/')} className="font-clash-display cursor-pointer text-[20px] mid:text-[30px] font-bold">
              get
              <span className="text-secondary">linked</span>
            </h1>
            <p className="lg:mt-1 mt-3 text-[12px]">
        ...
        <div className="lg:hidden mt-[39px] mb-8">
          <p className="flex text-[12px]">
            Terms of Use
            <span className="mx-[10px] w-[2px] h-[17px] bg-secondary inline-block" />
            Privacy Policy
          </p>
        </div>
        <div className="flex-1 flex flex-col lg:flex-row justify-between">
          ...
          <div className="flex gap-4 flex-1 items-center lg:hidden mt-[18px]">
          ...
          <div className="mt-16 lg:mt-0">
            <h2 className="text-[14px] font-semibold text-secondary lg:mb-[19px] mb-2">Contact Us</h2>
            <img src={Star3} alt="star" className="animate__animated animate__flash animate__infinite animate__slower lg:w-[15px] w-[7px] lg:h-[18px] h-2 absolute lg:-ml-[5%] ml-[30%]" />
            <div className="flex flex-col gap-[22px]">
              <div className="flex gap-4">
                <Phone />
                <p className="text-[12px]">+234 70 30710165</p>
              </div>
              <div className="flex gap-4">
                <Map />
      ...
      <div className="lg:flex mt-[18px] hidden">
        <div className="w-[60%]">
          <p className="flex text-[12px]">
            Terms of Use
            <span className="mx-[10px] w-[2px] h-[17px] bg-secondary inline-block" />
        ...
        <img src={Star2} alt="star" className="animate__animated animate__flash animate__infinite animate__slower w-[15px] h-[18px]" />
      </div>
      <div className="mt-[67px] w-full flex flex-col items-center">
        <img src={Star} alt="star" className="animate__animated animate__flash animate__infinite animate__slower w-[7px] h-2 lg:w-auto lg:h-auto" />
