                ...
                <div className={`${scrollY ? 'animate__slideInUp' : ''} animate__animated flex-1 mt-[10px] desktop:mt-0`} ref={ref}>
                    <div className='flex flex-col desktop:flex-row desktop:gap-[88px]'>
                        ...
                        <div className='w-full flex justify-end desktop:block'>
                            <img src={Star} alt='star' className='animate__animated animate__flash animate__infinite animate__slower desktop:w-[26px] w-3 desktop:h-8 h-[14px]'/>
                        </div>
                    </div>
                    <div className='desktop:mt-4 mt-[9px] flex flex-col desktop:flex-row desktop:gap-[22px] gap-[15px]'>
                        ...
                        <div className='flex desktop:self-end w-full justify-center -ml-[17%] desktop:ml-0'>
                            <img src={Star2} alt='star' className='animate__animated animate__flash animate__infinite animate__slower desktop:w-[26px] w-[10px] desktop:h-8 h-3 object-contain'/>
                        </div>
                    </div>
                </div>
