    ...
    <>
      <div className={`nav px-[8.4%] pt-[63px] pb-[25px] ${scrolled ? 'nav-fixed' : ''}`}>
        <div className="lg:w-[47%]">
          <h1 onClick={() => navigate('/')} className="font-clash-display cursor-pointer text-[30px] mid:text-[50px] font-bold">
            get
        ...
        <Hamburgers className="cursor-pointer md:hidden" onClick={() => setMenu(!menu)} />
      </div>
