    ...
    <div className="section-one ">
      <div className="flex flex-col lg:flex-row w-full items-center lg:pl-[13.54%] px-[47px] lg:pr-[6.51%] lg:pt-8 pt-[47px] pb-16" id="faq">
        <div className={`${scrollY ? 'animate__slideInUp' : ''} animate__animated flex-1 mt-10`} ref={ref}>
          ...
          <h1 className="lg:text-[32px] text-[20px] font-bold font-clash-display lg:w-[253px] text-center lg:text-start">
            Frequently Ask
            <br />
            <span className=" text-fuchsia-500">Question</span>
          </h1>
          <h2 className="lg:mt-4 mt-[6px] lg:w-[342px] lg:text-[14px] text-[12px] w-full text-center lg:text-start">
