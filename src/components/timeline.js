...
export default function Timeline() {
  ...
  return (
    <div className="section-plain">
      <div ref={ref} className={`${scrollY ? 'animate__slideInUp' : ''} animate__animated pt-[72px] w-full lg:px-[8.96%] px-[49px] lg:pb-[109px] pb-[34px]`} id="timeline">
        <div className="text-center w-full items-center flex flex-col">
          <h1 className="text-[20px] lg:text-[32px] font-bold font-clash-display lg:mb-3 mb-[21px]">Timeline</h1>
          <h2 className="text-[14px] w-[346px]">Here is the breakdown of the time we anticipate using for the upcoming event.</h2>
        </div>
        <div className="lg:mt-[91px] mt-6 w-full">
          <img src={Star} alt="star" className="animate__animated animate__flash animate__infinite animate__slower lg:w-[26px] w-[14px] lg:h-8 h-4 mb-4 lg:mb-0" />
          <div className="flex flex-col lg:gap-2 gap-[27px] lg:mt-[60px]">
            <div className="flex gap-5 justify-between">
              <div className="lg:hidden flex flex-col gap-[4.68px] items-center flex-1">
                <div className="h-[77px] w-[2px] bg-secondary" />
            ...
            <div className="flex gap-5 justify-between">
              ...
              <div className="flex lg:items-center justify-center w-full flex-col-reverse lg:flex-row">
                ...
                <div className="lg:flex hidden flex-col gap-[11px] items-center flex-1">
                  <div className="h-[86px] w-1 bg-secondary" />
                  <div className="h-[53px] w-[53px] circle bg-secondary flex justify-center items-center">
            ...
            <div className="flex gap-5 justify-between">
              ...
              <div className="flex items-center justify-center w-full flex-col lg:flex-row">
                ...
                <div className="flex lg:ml-[98px] lg:w-[35%] w-full h-full lg:h-auto items-end justify-between">
                  <p className="text-secondary lg:text-[24px] text-[12px] font-bold">November 18, 2023</p>
            ...
            <img src={Star3} alt="star" className="animate__animated animate__flash animate__infinite animate__slower lg:w-[26px] w-[10px] lg:h-8 h-3" />
          </div>
        </div>
      </div>
    </div>
