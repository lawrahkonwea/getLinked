...
export default function Success({ setSuccess }) {
  return (
    <div className="flex flex-col items-center">
      ...
      <h1 className="text-center lg:text-[32px] text-[16px] mt-[10px] lg:mt-0 font-semibold mb-[10px]">
        Congratulations
        <br />
        you have successfully Registered!
      </h1>
      <div className="flex items-end lg:gap-1 lg:mb-4 mb-[19px]">
        <h2 className="lg:text-[14px] text-[12px] lg:font-semibold font-medium text-center">
