...
import StarOutline from '../assets/star outlin.png';
...
export default function Contact() {
  ...
  return (
    ...
    >
      ...
      <div className="lg:mt-[51px] mt-[31px] lg:pb-[11.7%] pb-[36.44px] px-[8%] flex w-full">
        <img src={StarOutline} alt="star" className="animate__animated animate__flash animate__infinite animate__slower lg:block hidden mr-11 w-[23px] h-7 mt-[16%]" />
        <div className="flex flex-col flex-1">
          <img src={StarOpaque} alt="star" className="animate__animated animate__flash animate__infinite animate__slower absolute lg:static lg:w-[26px] w-4 lg:h-8 h-5 flex self-end mr-[5%]" />
          <img src={Star} alt="star" className="animate__animated animate__flash animate__infinite animate__slower lg:block hidden mt-1 w-[21px] h-[25px]" />
          <div className="lg:mt-8 flex w-full justify-between">
            ...
            <div className="flex lg:w-[60%] w-full">
              <div className="absolute -ml-[15px] flex items-center h-full">
                <img src={StarPu} alt="star" className="animate__animated animate__flash animate__infinite animate__slower lg:w-[30px] w-[12px] lg:h-9 h-[15px]" />
              </div>
              <div className="rounded-[12px] contact-box lg:w-[90%] w-full">
                <h1 className="text-[20px] font-semibold text-secondary">Questions or need assistance?</h1>
                <h1 className="lg:mt-[7px] text-[20px] font-semibold text-secondary">Let us know  about it!</h1>
                <p className="lg:hidden text-[12px] mt-6">Email us below to any question related to our event</p>
                <ContactForm />
              </div>
              <div className="h-full flex items-end lg:ml-[54px] ">
                <img src={StarWhite} alt="star" className="animate__animated animate__flash animate__infinite animate__slower lg:w-[26px] w-[12px] lg:h-8 h-[15px]" />
              </div>
            </div>
          </div>
          <div className="mt-[41px] lg:hidden w-full items-center flex flex-col">
